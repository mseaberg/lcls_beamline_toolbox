import numpy as np
import lcls_beamline_toolbox.xraybeamline2d.beam as beam
import lcls_beamline_toolbox.xraybeamline2d.optics as optics
import lcls_beamline_toolbox.xraybeamline2d.beamline2d as beamline
import lcls_beamline_toolbox.xraybeamline2d.motion as motion
import lcls_beamline_toolbox.utility.util as util

class MFX:
    def __init__(self, E0, N=512, ax=0.0, ay=0.0):
    ...
    def undulator_pointing(self,ax=0.0,ay=0.0):
